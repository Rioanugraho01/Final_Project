...
<section class="pt-3">
    <div class="container-fluid" style= "background-image: url('/assets/animasi.svg'); width: 100%; height: 250px;">
        <p class="text-light text-center"
            style="padding-top: 70px; font-size: 50px; font-family: Poetsen One, sans-serif;">Beasiswa S3</p>
    </div>
</section>

<section>
    <div class="container">
        <p class="pt-5" style="font-size: 25px;"><b>Beasiswa S2 dan S3 di Universitas Padjadjaran</b></p>
    ...
    <div class="container">
        <p style="font-size: 25px;"><b>Beasiswa S3 di University of Warwick, UK</b></p>
    ...
    <div class="container">
        <p style="font-size: 25px;"><b>Beasiswa S2 dan S3 di University of Oxford, Inggris</b></p>
    ...
    <div class="container">
        <p style="font-size: 25px;"><b>Beasiswa S3 HKPFS di Hong Kong</b></p>
