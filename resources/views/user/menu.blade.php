...
<section class="pt-3">
    <div class="container-fluid" style="background-image: url('/assets/animasi.svg'); width: 100%; height: 250px;">
        <p class="text-light text-center" style="padding-top: 80px; font-size: 50px; font-family: Poetsen One, sans-serif;">Dashboard</p>
    </div>
</section>
...
<section class="container d-flex justify-content-center pt-5 mt-3">
    <div class="row gap-5">
        ...
        <article class="card shadow" style="width: 18rem;">
            <img src="https://www.scholarsofficial.com/wp-content/uploads/2022/04/BEASISWA.png" class="card-img-top" alt="Beasiswa">
            <div class="card-body">
